"""add table tbl_cfg_general_ledger

Revision ID: 4445c453a905
Revises: e3b8896e76c9
Create Date: 2026-01-10 14:09:38.263789
...
revision = '4445c453a905'
down_revision = 'e3b8896e76c9'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.alter_column('tbl_cfg_matching_rule', 'version_number',
               existing_type=sa.INTEGER(),
               nullable=False)
    # Indexes and columns already exist, skip creating them
...
def downgrade() -> None:
    ...
    # Drop columns from tbl_upload_files
