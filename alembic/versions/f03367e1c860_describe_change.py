...
def upgrade() -> None:
    ...
    # op.drop_index(
    #     op.f("idx_txn_duplicate_check"),
    #     table_name="tbl_txn_transactions",
    #     postgresql_where="((match_status IS NULL) OR (match_status = 0))",
    # )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(
        op.f("idx_upload_file_status"), "tbl_upload_files", ["status"], unique=False
    )
    op.create_index(
        op.f("idx_upload_file_channel"),
        "tbl_upload_files",
        ["channel_id"],
        unique=False,
    )
    op.create_index(
        op.f("idx_txn_file_id"),
    ...
    op.create_index(
        op.f("idx_txn_date"), "tbl_txn_transactions", ["date"], unique=False
    )
    op.create_index(
        op.f("idx_txn_created_at"),
        "tbl_txn_transactions",
        [sa.literal_column("created_at DESC")],
        unique=False,
    )
    op.create_index(
        op.f("idx_txn_channel_source"),
        "tbl_txn_transactions",
    ...
    op.create_table(
        ...
        sa.Column(
            "manual_txn_id", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "file_transactions_id", sa.BIGINT(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "reconciled_status", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["channel_id"], ["tbl_cfg_channels.id"], name=op.f("fk_manual_channel")
        ),
        sa.ForeignKeyConstraint(
            ["created_by"], ["tbl_cfg_users.id"], name=op.f("fk_manual_created_by")
        ),
        sa.ForeignKeyConstraint(
            ["file_transactions_id"],
            ["tbl_upload_files.id"],
            name=op.f("fk_manual_file"),
        ),
        sa.ForeignKeyConstraint(
            ["reconciled_by"],
            ["tbl_cfg_users.id"],
            name=op.f("fk_manual_reconciled_by"),
        ),
        sa.ForeignKeyConstraint(
            ["source_id"], ["tbl_cfg_source.id"], name=op.f("fk_manual_source")
        ),
        sa.ForeignKeyConstraint(
            ["updated_by"], ["tbl_cfg_users.id"], name=op.f("fk_manual_updated_by")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "account_brn", sa.VARCHAR(length=20), autoincrement=False, nullable=True
        ),
        sa.Column(
            "account_number", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        ...
        sa.Column(
            "post_status", sa.VARCHAR(length=20), autoincrement=False, nullable=True
        ),
        sa.Column("post_date", sa.DATE(), autoincrement=False, nullable=True),
        sa.Column(
            "batch_no", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "source_id", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "auth_stat", sa.VARCHAR(length=20), autoincrement=False, nullable=True
        ),
        sa.Column(
            "maker_id", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "maker_dt_stamp", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "checker_id", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "checker_dt_stamp",
            postgresql.TIMESTAMP(),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.BIGINT(), autoincrement=True, nullable=False),
        sa.Column(
            "general_ledger", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "gl_role", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column(
            "channel_id", sa.VARCHAR(length=50), autoincrement=False, nullable=True
        ),
        sa.Column(
            "apply_to_all_channels", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "gl_description", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column(
            "created_at",
            postgresql.TIMESTAMP(),
