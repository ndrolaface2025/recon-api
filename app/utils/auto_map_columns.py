...
CANONICAL_FIELDS = {
    ...
    "amount": ["amount", "txn_amount", "transaction_amount", "amt", "Amount"],
    "date": ["txn_date", "transaction_date", "datetime", "date_time", "date", "time", "timestamp", "DateTime"],
    ...
    "pan": ["pan", "card_number", "card", "card_no", "pan_masked"],
